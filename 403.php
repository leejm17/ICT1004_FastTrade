        ...
        <div class="nk-gap-3"></div>
            <div class="row">
                <div style="text-align: center;" class="col-lg-12 col-md-6 col-sm-3">
                    ...
                    <p>Click the button here to go to back to login</p>
                    <button type="submit" class="nk-btn nk-btn-color-dark-1"onclick="location.href='login.php';">Back to Login</button>
                </div>
            </div>
        <div class="nk-gap-3"></div>
        <div class="nk-gap-6"></div>
