...
<head>
    ...
    <title>Fast Trade | Products Sold</title>

    <meta name="description" content="Review Sold Products">
    <meta name="keywords" content="sold, products, review">
...
<!-- END: Navbar Mobile -->
    ...
    <div class="bg-white">
        <div class="container-fluid">
            ...
            <h2 class="text-center">Items Sold</h2>
            ...
            <?php
                ...
                $sql = "SELECT item_photo.photo, item.title, offer.buyer_id, item.price, offer.asking_price, offer.trading_place, offer.remarks, item.description, item.item_id
                        ...
                        WHERE offer.seller_id = '" . $userid . "' AND offer.accept = 1 AND item.sold = 1
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <div class="row vertical-gap align-items-center" style="border: 3px solid #999; border-radius: 10px;">
                                    ...
                                    <div class="col-md-4 col-sm-4" style="">
                                        ...
                                        <h1 class="nk-product-title h6">Bought By: '. $row['buyer_id'] .'</h1>
                                         <!--END: Title-->
                                        <div class="nk-product-description">
                                            ...
                                            <table class="table" style="width:100%;">
                                                <tr>
                                                    ...
                                                    <td class="addinfo_table_left"><span><strong>Sold At: </strong>SGD '. $row['asking_price'] .'</span></td>
                                                </tr>
                                                <tr>
                        ...
                        <div class="row">
                            <div style="text-align: center;" class="col-lg-12 col-md-6 col-sm-3">
                                <p style="font-size: 24px;">You have no items sold.</p>
