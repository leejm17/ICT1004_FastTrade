...
<head>
    ...
    <title>Fast Trade | Offers Accepted</title>

    <meta name="description" content="Review Offers Accepted">
    <meta name="keywords" content="offers, accepted, review">
...
<!-- END: Navbar Mobile -->
    ...
    <div class="bg-white">
        <div class="container-fluid">
            ...
            <h2 class="text-center">Your Offers Accepted</h2>
            ...
            <?php
                ...
                $sql = "SELECT item_photo.photo, item.title, offer.seller_id, item.price, offer.asking_price, offer.trading_place, offer.remarks, item.description, item.item_id
                        ...
                        WHERE offer.buyer_id = '" . $userid . "' AND offer.accept = 1 AND item.sold = 1
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        <div class="row">
                            <div style="text-align: center;" class="col-lg-12 col-md-6 col-sm-3">
                                <p style="font-size: 24px;">You have no confirmed offers.</p>
